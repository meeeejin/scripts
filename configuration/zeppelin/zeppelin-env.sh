...
export SPARK_MASTER=spark://xxx.xxx.xxx.205:7077
...
##
export SPARK_HOME=/home/skt/spark                             
...
export HADOOP_CONF_DIR=/home/skt/hadoop-3.2.2/etc/hadoop                        
#export YARN_CONF_DIR=/home/skt/hadoop-3.2.2/etc/hadoop
...
export LIGHTNINGDB_LIB_PATH=$HOME/deploy/lib-support-binary-arrow-scan-71c63b
export SPARK_RAPIDS_DIR=$HOME/sparkRapidsPlugin
export SPARK_RAPIDS_PLUGIN_JAR=$HOME/sparkRapidsPlugin/rapids-4-spark_2.12-0.5.0.jar
export SPARK_CUDF_JAR=$HOME/sparkRapidsPlugin/cudf-0.19.2-cuda11.jar
export SPARK_SUBMIT_OPTIONS="--jars $(find $LIGHTNINGDB_LIB_PATH -name '*.jar' | tr '\n' ',')$SPARK_RAPIDS_PLUGIN_JAR,$SPARK_CUDF_JAR --files ${SPARK_RAPIDS_DIR}/getGpusResources.sh --conf \"spark.driver.defaultJavaOptions=-Duser.timezone=GMT\" --conf \"spark.executor.extraJavaOptions=-Duser.timezone=GMT\""
